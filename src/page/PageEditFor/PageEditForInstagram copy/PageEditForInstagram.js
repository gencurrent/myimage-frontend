...
import DragAndDrop from './node_modules/components/DragAndDrop';
import Cropper from './node_modules/components/Cropper';
import TitleSubtitle from './node_modules/components/TitleSubtitle';


class PageEditForInstagram extends React.Component {
    constructor(props){
        super(props);
...
export default withAlert()(PageEditForInstagram);